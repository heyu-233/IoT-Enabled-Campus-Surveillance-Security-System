...
('Camera 1', 'edge-camera-01', '192.168.1.100', 554, 'Main Entrance', 'ONLINE', 'http://127.0.0.1:8080/live/camera1.flv', NOW(), NOW(), NOW()),
('Camera 2', 'edge-camera-02', '192.168.1.101', 554, 'Back Entrance', 'ONLINE', 'http://127.0.0.1:8080/live/camera2.flv', NOW(), NOW(), NOW()),
('Camera 3', 'edge-camera-03', '192.168.1.102', 554, 'Parking Lot', 'OFFLINE', 'http://127.0.0.1:8080/live/camera3.flv', NOW(), NOW(), NOW());

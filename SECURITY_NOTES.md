...
- Removed thesis documents, proposals, presentations, ZIP archives, and support materials
...
- `end_part/video_stream/best.pt` is intentionally kept because it is the active demo inference model
